defmodule Polarex.Documented do
  ...
  **Scopes**: `webhooks:write`
  ...
  def webhooks_create_webhook_endpoint(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Polarex.Documented, :webhooks_create_webhook_endpoint},
  ...
  **Scopes**: `webhooks:write`
  ...
  def webhooks_delete_webhook_endpoint(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Polarex.Documented, :webhooks_delete_webhook_endpoint},
  ...
  **Scopes**: `webhooks:read` `webhooks:write`
  ...
  def webhooks_get_webhook_endpoint(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Polarex.Documented, :webhooks_get_webhook_endpoint},
      url: "/v1/webhooks/endpoints/#{id}",
      method: :get,
      response: [
  ...
  **Scopes**: `webhooks:read` `webhooks:write`
  ...
  def webhooks_list_webhook_deliveries(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Polarex.Documented, :webhooks_list_webhook_deliveries},
  ...
  **Scopes**: `webhooks:read` `webhooks:write`
  ...
  def webhooks_list_webhook_endpoints(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Polarex.Documented, :webhooks_list_webhook_endpoints},
      url: "/v1/webhooks/endpoints",
      method: :get,
      query: query,
      response: [
  ...
  **Scopes**: `webhooks:write`
  ...
  def webhooks_redeliver_webhook_event(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Polarex.Documented, :webhooks_redeliver_webhook_event},
  ...
  **Scopes**: `webhooks:write`
  ...
  def webhooks_update_webhook_endpoint(id, body, opts \\ []) do
    ...
    client.request(%{
      args: [id: id, body: body],
      call: {Polarex.Documented, :webhooks_update_webhook_endpoint},
      url: "/v1/webhooks/endpoints/#{id}",
      body: body,
      method: :patch,
