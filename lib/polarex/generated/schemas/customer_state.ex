defmodule Polarex.Generated.CustomerState do
  @moduledoc """
  Provides struct and type for a CustomerState
  """

  @type t :: %__MODULE__{
          active_meters: [Polarex.Generated.CustomerStateMeter.t()],
          active_subscriptions: [Polarex.Generated.CustomerStateSubscription.t()],
          avatar_url: String.t(),
          ...
          granted_benefits: [Polarex.Generated.CustomerStateBenefitGrant.t()],
          id: String.t(),
