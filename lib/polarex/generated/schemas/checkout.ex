defmodule Polarex.Generated.Checkout do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          customer_billing_address_fields:
            Polarex.Generated.CheckoutCustomerBillingAddressFields.t(),
          ...
          payment_processor_metadata: Polarex.Generated.PaymentProcessorMetadata.t(),
          product: Polarex.Generated.CheckoutProduct.t(),
          product_id: String.t(),
          product_price: map,
          product_price_id: String.t(),
          products: [Polarex.Generated.CheckoutProduct.t()],
