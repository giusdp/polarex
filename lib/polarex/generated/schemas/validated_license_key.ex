defmodule Polarex.Generated.ValidatedLicenseKey do
  @moduledoc """
  Provides struct and type for a ValidatedLicenseKey
  """

  @type t :: %__MODULE__{
          activation: Polarex.Generated.LicenseKeyActivationBase.t() | nil,
          benefit_id: String.t(),
          created_at: DateTime.t(),
          customer: Polarex.Generated.LicenseKeyCustomer.t(),
  ...
  def __fields__(:t) do
    [
      activation: {:union, [{Polarex.Generated.LicenseKeyActivationBase, :t}, :null]},
