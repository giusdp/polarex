defmodule Polarex.Generated.CustomerSubscription do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          id: String.t(),
          meters: [Polarex.Generated.CustomerSubscriptionMeter.t()],
          modified_at: DateTime.t() | nil,
          prices: [map],
          product: Polarex.Generated.CustomerSubscriptionProduct.t(),
          product_id: String.t(),
