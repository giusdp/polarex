defmodule Polarex.Generated.Order do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          customer: Polarex.Generated.OrderCustomer.t(),
          customer_id: String.t(),
          discount: map | nil,
          discount_amount: integer,
          discount_id: String.t() | nil,
          id: String.t(),
          items: [Polarex.Generated.OrderItemSchema.t()],
          metadata: Polarex.Generated.Metadata.t(),
          modified_at: DateTime.t() | nil,
          net_amount: integer,
          paid: boolean,
          product: Polarex.Generated.OrderProduct.t(),
          product_id: String.t(),
          refunded_amount: integer,
          refunded_tax_amount: integer,
          status: String.t(),
          subscription: Polarex.Generated.OrderSubscription.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      subscription: {:union, [{Polarex.Generated.OrderSubscription, :t}, :null]},
