defmodule Polarex.Generated.CustomerOrder do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          net_amount: integer,
          paid: boolean,
          product: Polarex.Generated.CustomerOrderProduct.t(),
          product_id: String.t(),
          refunded_amount: integer,
          refunded_tax_amount: integer,
          status: String.t(),
          subscription: Polarex.Generated.CustomerOrderSubscription.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      subscription: {:union, [{Polarex.Generated.CustomerOrderSubscription, :t}, :null]},
