defmodule Polarex.Generated.Subscriptions do
  @moduledoc """
  ...
  **Scopes**: `customer_portal:write`
  ...
  def customer_portal_subscriptions_cancel(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Polarex.Generated.Subscriptions, :customer_portal_subscriptions_cancel},
  ...
  **Scopes**: `customer_portal:read` `customer_portal:write`
  ...
  def customer_portal_subscriptions_get(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Polarex.Generated.Subscriptions, :customer_portal_subscriptions_get},
      url: "/v1/customer-portal/subscriptions/#{id}",
      method: :get,
      response: [
        {200, {Polarex.Generated.CustomerSubscription, :t}},
  ...
  **Scopes**: `customer_portal:read` `customer_portal:write`
  ...
  def customer_portal_subscriptions_list(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Polarex.Generated.Subscriptions, :customer_portal_subscriptions_list},
  ...
  **Scopes**: `customer_portal:write`
  ...
  def customer_portal_subscriptions_update(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Polarex.Generated.Subscriptions, :customer_portal_subscriptions_update},
      url: "/v1/customer-portal/subscriptions/#{id}",
      body: body,
      method: :patch,
      request: [
  ...
  **Scopes**: `subscriptions:read` `subscriptions:write`
  ...
  def subscriptions_export(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Polarex.Generated.Subscriptions, :subscriptions_export},
  ...
  **Scopes**: `subscriptions:write`
  ...
  def subscriptions_get(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Polarex.Generated.Subscriptions, :subscriptions_get},
  ...
  **Scopes**: `subscriptions:read` `subscriptions:write`
  ...
  def subscriptions_list(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Polarex.Generated.Subscriptions, :subscriptions_list},
  ...
  **Scopes**: `subscriptions:write`
  ...
  def subscriptions_revoke(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Polarex.Generated.Subscriptions, :subscriptions_revoke},
      url: "/v1/subscriptions/#{id}",
      method: :delete,
      response: [
        {200, {Polarex.Generated.Subscription, :t}},
  ...
  **Scopes**: `subscriptions:write`
  ...
  def subscriptions_update(id, body, opts \\ []) do
    ...
    client.request(%{
      args: [id: id, body: body],
      call: {Polarex.Generated.Subscriptions, :subscriptions_update},
      url: "/v1/subscriptions/#{id}",
      body: body,
      method: :patch,
      request: [
