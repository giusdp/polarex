defmodule Polarex.Generated.Oauth2 do
  @moduledoc """
  ...
  def oauth2_authorize(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Polarex.Generated.Oauth2, :oauth2_authorize},
  ...
  def oauth2_clients_list(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Polarex.Generated.Oauth2, :oauth2_clients_list},
      url: "/v1/oauth2/",
      method: :get,
      query: query,
      response: [
  ...
  def oauth2_clients_oauth2_create_client(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Polarex.Generated.Oauth2, :oauth2_clients_oauth2_create_client},
  ...
  def oauth2_clients_oauth2_delete_client(client_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Polarex.Generated.Oauth2, :oauth2_clients_oauth2_delete_client},
  ...
  def oauth2_clients_oauth2_get_client(client_id, opts \\ []) do
    ...
    client.request(%{
      args: [client_id: client_id],
      call: {Polarex.Generated.Oauth2, :oauth2_clients_oauth2_get_client},
      url: "/v1/oauth2/register/#{client_id}",
      method: :get,
      response: [{200, :map}, {422, {Polarex.Generated.HTTPValidationError, :t}}],
      opts: opts
  ...
  def oauth2_clients_oauth2_update_client(client_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Polarex.Generated.Oauth2, :oauth2_clients_oauth2_update_client},
      url: "/v1/oauth2/register/#{client_id}",
      body: body,
      method: :put,
  ...
  def oauth2_introspect_token(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Polarex.Generated.Oauth2, :oauth2_introspect_token},
  ...
  def oauth2_request_token(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Polarex.Generated.Oauth2, :oauth2_request_token},
      url: "/v1/oauth2/token",
      body: body,
      method: :post,
      request: [
  ...
  def oauth2_revoke_token(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Polarex.Generated.Oauth2, :oauth2_revoke_token},
  ...
  def oauth2_userinfo(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Polarex.Generated.Oauth2, :oauth2_userinfo},
