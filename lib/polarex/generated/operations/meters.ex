defmodule Polarex.Generated.Meters do
  @moduledoc """
  ...
  **Scopes**: `meters:write`
  ...
  def meters_create(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Polarex.Generated.Meters, :meters_create},
      url: "/v1/meters/",
      body: body,
      method: :post,
  ...
  **Scopes**: `meters:read` `meters:write`
  ...
  def meters_get(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Polarex.Generated.Meters, :meters_get},
      url: "/v1/meters/#{id}",
      method: :get,
      response: [
  ...
  **Scopes**: `meters:read` `meters:write`
  ...
  def meters_list(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Polarex.Generated.Meters, :meters_list},
      url: "/v1/meters/",
      method: :get,
      query: query,
      response: [
  ...
  **Scopes**: `meters:read` `meters:write`
  ...
  def meters_quantities(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Polarex.Generated.Meters, :meters_quantities},
  ...
  **Scopes**: `meters:write`
  ...
  def meters_update(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Polarex.Generated.Meters, :meters_update},
      url: "/v1/meters/#{id}",
      body: body,
      method: :patch,
