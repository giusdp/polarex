defmodule Polarex.CustomerBenefitGrantSlackSharedChannel do
  @moduledoc """
  Provides struct and type for a CustomerBenefitGrantSlackSharedChannel
  """

  @type t :: %__MODULE__{
          benefit: Polarex.BenefitSlackSharedChannelSubscriber.t(),
          benefit_id: String.t(),
          ...
          properties: Polarex.BenefitGrantSlackSharedChannelProperties.t(),
