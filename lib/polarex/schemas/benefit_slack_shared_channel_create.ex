defmodule Polarex.BenefitSlackSharedChannelCreate do
  @moduledoc """
  Provides struct and type for a BenefitSlackSharedChannelCreate
  """
  ...
  @type t :: %__MODULE__{
          ...
          properties: Polarex.BenefitSlackSharedChannelCreateProperties.t(),
          type: String.t(),
