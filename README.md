...
> For the stable release, see the upstream [Polarex](https://github.com/giusdp/polarex) on [Hex](https://hex.pm/packages/polarex).
...
def deps do
  [
    {:polarex, github: "spapiernik/polarex-nightly", tag: "v2026.06.04"}
  ]
end
```
